...
import mapDesktop from '../assets/homepage/mapDesktop.svg';
...
const HomePageNew = () => {
    ...
    return (
        <div className='bg-[#F5F5F5]'>
            {/* Desktop */}
            <div className="hidden md:flex justify-center pt-[6vh] pb-[6vh]">
                <div className="max-w-[76vw] grid grid-cols-2 gap-[12vw] items-start">
                    ...
                    <img src={mapDesktop} alt="Map" className="relative justify-center items-center -mt-20" />
