    ...
    return (
        <div className="bg-[#F5F5F5] ">
            ...
            <div className="md:hidden flex flex-col items-center p-2 overflow-x-hidden overflow-y-visible">
                ...
                <div
                    className="border-4 bg-[var(--color-yellow)] rounded-[10px] w-[92vw] py-4 mt-8 flex justify-center items-center"
                    style={{ boxShadow: "0px 4px 0px rgba(0, 0, 0, 1)" }}
                >
                    <h2 className="font-atkinson-bold text-[4vw] text-black tracking-wider">
                        WE PROCESS C-41 AND B&W FILM ONLY
                    </h2>
                </div>

                <div className="border-4 rounded-[10px] w-[92vw] mt-8 mb-8 p-3" style={{ boxShadow: "0px 4px 0px rgba(0, 0, 0, 1)" }}>
                    ...
                    <h1 className="font-atkinson-bold text-[var(--color-pink)] text-[4vw] w-full tracking-wider text-center mt-6">STANDARD TURNAROUND TIME<br /> FOR C-41 IS TWO DAYS,<br /> B&W IS APPROXIMATELY FIVE DAYS</h1>
                    <div className='flex justify-between mt-4'>
                        <h2 className='font-atkinson-bold text-[3.111vw] tracking-wider'>35mm Dev&Scan</h2>
                        <p className='font-atkinson-regular text-[3.111vw] tracking-wider'>$19.99</p>
                    </div>
                    <div>
                        <h2 className='font-atkinson-bold text-[3.111vw] tracking-wider'>35mm Dev&Print Only</h2>
                    </div>
                    <div className='relative'>
                        ...
                        <div className='flex justify-end gap-[12vw]'>
                            <h2 className='font-atkinson-regular text-[3.111vw] tracking-wider mt-3 whitespace-nowrap '>Disposable Cameras, 24-27 Exp.</h2>
                            <p className='font-atkinson-regular text-[3.111vw] tracking-wider mt-3 whitespace-nowrap '>$23.99</p>
                        </div>
                        <div className='flex justify-end gap-[18.5vw]'>
                            <h2 className='font-atkinson-regular text-[3.111vw] tracking-wider whitespace-nowrap '>Regular 35mm Roll, 36 Exp.</h2>
                            <p className='font-atkinson-regular text-[3.111vw] tracking-wider whitespace-nowrap '>$25.99</p>
                        </div>
                    </div>
                    <div>
                        <h2 className='font-atkinson-bold text-[3.111vw] tracking-wider'>35mm Half-Frame Dev&Scan</h2>
                    </div>
                    <div className='relative'>
                        <img src={arrowRight} alt="Arrow Right" className="absolute left-0 top-4 -translate-y-1/2 w-[10vw]" />
                        <div className='flex justify-end gap-[47vw]'>
                            <h2 className='font-atkinson-regular text-[3.111vw] tracking-wider mt-3'>Diptychs</h2>
                            <p className='font-atkinson-regular text-[3.111vw] tracking-wider mt-3'>$24.99</p>
                        </div>
                        <div className='flex justify-end gap-[43.4vw]'>
                            <h2 className='font-atkinson-regular text-[3.111vw] tracking-wider'>Individuals</h2>
                            <p className='font-atkinson-regular text-[3.111vw] tracking-wider'>$27.99</p>
                        </div>
                    </div>
                    <div className='flex justify-between mt-0.5'>
                        <h2 className='font-atkinson-bold text-[3.111vw] tracking-wider'>110 Dev&Scan (w/ or w/o borders)</h2>
                        <p className='font-atkinson-regular text-[3.111vw] tracking-wider'>$24.99</p>
                    </div>
                    <div className='flex justify-between mt-0.5'>
                        <h2 className='font-atkinson-bold text-[3.111vw] tracking-wider'>APS Dev&Scan (w/ or w/o borders)</h2>
                        <p className='font-atkinson-regular text-[3.111vw] tracking-wider'>$29.99</p>
                    </div>
                    <div className='flex justify-between mt-0.5'>
                        <h2 className='font-atkinson-bold text-[3.111vw] tracking-wider'>120 Dev&Scan (medium format, hi-res)</h2>
                        <p className='font-atkinson-regular text-[3.111vw] tracking-wider'>$29.99</p>
                    </div>
                    <div className='flex justify-between mt-0.5'>
                        <h2 className='font-atkinson-bold text-[3.111vw] tracking-wider'>220 Dev&Scan (medium format, hi-res)</h2>
                        <p className='font-atkinson-regular text-[3.111vw] tracking-wider'>$49.99</p>
                    </div>



                    <div className='bg-[var(--color-green)] rounded-[10px] -mx-10 border-4 text-center font-atkinson-bold text-[4vw] tracking-wider py-2 mt-5' style={{ boxShadow: "0px 4px 0px rgba(0, 0, 0, 1)" }}>
                        HI-RES 6774X4492 PX FOR $6.99
                    </div>


                    <h1 className="font-atkinson-bold text-[var(--color-pink)] text-[4vw] tracking-wider text-center mt-6">ADDS-ONS, PER ROLL</h1>
                    <div className='flex justify-between mt-4'>
                        <h2 className='font-atkinson-bold text-[3.111vw] tracking-wider'>Custom Color Grading</h2>
                        <p className='font-atkinson-regular text-[3.111vw] tracking-wider'>$06.99</p>
                    </div>
                    <div className='flex justify-between mt-0.5'>
                        <h2 className='font-atkinson-bold text-[3.111vw] tracking-wider'>TIFFS</h2>
                        <p className='font-atkinson-regular text-[3.111vw] tracking-wider'>$01.99</p>
                    </div>
                    <div className='flex justify-between mt-0.5'>
                        <h2 className='font-atkinson-bold text-[3.111vw] tracking-wider'>Hi-Res Scan + 16-bit TIFFS</h2>
                        <p className='font-atkinson-regular text-[3.111vw] tracking-wider'>$14.99</p>
                    </div>
                    <div className='flex justify-between mt-0.5'>
                        <h2 className='font-atkinson-bold text-[3.111vw] tracking-wider'>Panoramic Scan for any format</h2>
                        <p className='font-atkinson-regular text-[3.111vw] tracking-wider'>$09.99</p>
                    </div>
                    <div className='flex justify-between mt-0.5'>
                        <h2 className='font-atkinson-bold text-[3.111vw] tracking-wider'>Sprocket Scan for 35mm</h2>
                        <p className='font-atkinson-regular text-[3.111vw] tracking-wider'>$14.99</p>
                    </div>
                    <div className='flex justify-between mt-0.5'>
                        <h2 className='font-atkinson-bold text-[3.111vw] tracking-wider'>B&W Push/Pull</h2>
                        <p className='font-atkinson-regular text-[3.111vw] tracking-wider'>$01.99/Stop</p>
                    </div>
                    <div className='flex justify-between mt-0.5'>
                        <h2 className='font-atkinson-bold text-[3.111vw] tracking-wider'>B&W Processing for C-41 Old Film</h2>
                        <p className='font-atkinson-regular text-[3.111vw] tracking-wider'>$05.99</p>
                    </div>
                    <div className='flex justify-between mt-0.5'>
                        <h2 className='font-atkinson-bold text-[3.111vw] tracking-wider'>Restoration: request an estimate at drop-off</h2>
                    </div>

                    <h1 className="font-atkinson-bold text-[var(--color-pink)] text-[4vw] tracking-wider text-center mt-6">PRINT SET - WE USE LUSTER ONLY</h1>
                    <div className='mt-4'>
                        <h2 className='font-atkinson-bold text-[3.111vw] tracking-wider'>4X6 Prints</h2>
                    </div>
                    <div className='relative'>
                        <img src={arrowRight} alt="Arrow Right" className="absolute left-0 top-4 -translate-y-1/2 w-[10vw]" />
                        <div className='flex justify-end gap-[44vw]'>
                            <h2 className='font-atkinson-regular text-[3.111vw] tracking-wider mt-3'>24-27 Exp.</h2>
                            <p className='font-atkinson-regular text-[3.111vw] tracking-wider mt-3'>$08.99</p>
                        </div>
                        <div className='flex justify-end gap-[49.5vw]'>
                            <h2 className='font-atkinson-regular text-[3.111vw] tracking-wider'>36 Exp.</h2>
                            <p className='font-atkinson-regular text-[3.111vw] tracking-wider'>$10.99</p>
                        </div>
                    </div>
                    <div className='flex justify-between'>
                        <h2 className='font-atkinson-bold text-[3.111vw] tracking-wider'>5X7 Print</h2>
                        <p className='font-atkinson-regular text-[3.111vw] tracking-wider'>$04.99</p>
                    </div>
                    <div className='flex justify-between'>
                        <h2 className='font-atkinson-bold text-[3.111vw] tracking-wider'>8X10 / 8X12 Print</h2>
                        <p className='font-atkinson-regular text-[3.111vw] tracking-wider'>$14.99</p>
                    </div>
                    <div className='relative'>
                        <img src={arrowRight} alt="Arrow Right" className="absolute left-0 top-4 -translate-y-1/2 w-[10vw]" />
                        <div className='flex pl-[14vw]'>
                            <h2 className='font-atkinson-regular text-[3.111vw] tracking-wider mt-3'>or $9.99 for 10+ prints</h2>
                        </div>
                    </div>


                    <h1 className="font-atkinson-bold text-[var(--color-pink)] text-[4vw] tracking-wider text-center mt-6">SCANS (PER ROLL, CUT OR UNCUT)</h1>
                    <div className='flex justify-between mt-4'>
                        <h2 className='font-atkinson-bold text-[3.111vw] tracking-wider'>35mm</h2>
                        <p className='font-atkinson-regular text-[3.111vw] tracking-wider'>$19.99</p>
                    </div>
                    <div className='flex justify-between mt-0.5'>
                        <h2 className='font-atkinson-bold text-[3.111vw] tracking-wider'>120 (standard formats)</h2>
                        <p className='font-atkinson-regular text-[3.111vw] tracking-wider'>$19.99</p>
                    </div>
                    <div className='flex justify-between mt-0.5'>
                        <h2 className='font-atkinson-bold text-[3.111vw] tracking-wider'>110</h2>
                        <p className='font-atkinson-regular text-[3.111vw] tracking-wider'>$24.99</p>
                    </div>
                    <div className='flex justify-between mt-0.5'>
                        <h2 className='font-atkinson-bold text-[3.111vw] tracking-wider'>APS</h2>
                        <p className='font-atkinson-regular text-[3.111vw] tracking-wider'>$29.99</p>
                    </div>
                    <div className='flex justify-between mt-0.5'>
                        <h2 className='font-atkinson-bold text-[3.111vw] tracking-wider'>Panoramic Formats</h2>
                        <p className='font-atkinson-regular text-[3.111vw] tracking-wider'>$29.99</p>
                    </div>


                    <h1 className="font-atkinson-bold text-[var(--color-pink)] text-[4vw] tracking-wider text-center mt-6">NON-FILM ROLL SCANS</h1>
                    <div className='mt-4'>
                        <h2 className='font-atkinson-bold text-[3.111vw] tracking-wider'>Mounted Slides</h2>
                    </div>
                    <div className='relative'>
                        <img src={arrowRight} alt="Arrow Right" className="absolute left-0 top-4 -translate-y-1/2 w-[10vw]" />
                        <div className='flex pl-[14vw]'>
                            <h2 className='font-atkinson-regular text-[3.111vw] tracking-wider mt-3'>$5 each, minimum 5 slides</h2>
                        </div>
                        <div className='flex pl-[14vw]'>
                            <h2 className='font-atkinson-regular text-[3.111vw] tracking-wider'>$4 each for 50+ slides</h2>
                        </div>
                    </div>
                    <div className='mt-4'>
                        <h2 className='font-atkinson-bold text-[3.111vw] tracking-wider'>Standard Prints</h2>
                    </div>
                    <div className='relative'>
                        <img src={arrowRight} alt="Arrow Right" className="absolute left-0 top-4 -translate-y-1/2 w-[10vw]" />
                        <div className='flex pl-[14vw]'>
                            <h2 className='font-atkinson-regular text-[3.111vw] tracking-wider mt-3'>8x10 and smaller: $5 each, minimum 5 prints</h2>
                        </div>
                        <div className='flex pl-[14vw]'>
                            <h2 className='font-atkinson-regular text-[3.111vw] tracking-wider'>8x12 and bigger: $19.99</h2>
                        </div>
                    </div>
                    <div className='flex justify-between mt-0.5'>
                        <h2 className='font-atkinson-bold text-[3.111vw] tracking-wider'>VHS Transfer</h2>
                        <p className='font-atkinson-regular text-[3.111vw] tracking-wider'>$19.99/Tape</p>
                    </div>


                    <h1 className="font-atkinson-bold text-[var(--color-pink)] text-[4vw] tracking-wider text-center mt-6">RUSH SERVICES FOR C-41 FILM<br /> AND DISPOSABLE CAMERAS</h1>
                    <div className='flex justify-between mt-4'>
                        <h2 className='font-atkinson-bold text-[3.111vw] tracking-wider'>Same-Day</h2>
                        <p className='font-atkinson-regular text-[3.111vw] tracking-wider'>$44.99</p>
                    </div>
                    <div className='flex justify-between mt-0.5'>
                        <h2 className='font-atkinson-bold text-[3.111vw] tracking-wider'>Next-Day</h2>
                        <p className='font-atkinson-regular text-[3.111vw] tracking-wider'>$34.99</p>
                    </div>

                    <h1 className="font-atkinson-bold text-[var(--color-pink)] text-[4vw] tracking-wider text-center mt-6">RUSH SERVICES FOR C-41 FILM<br /> IN 120, 110 AND APS FORMATS</h1>
                    <div className='flex justify-between mt-4'>
                        <h2 className='font-atkinson-bold text-[3.111vw] tracking-wider'>Same-Day</h2>
                        <p className='font-atkinson-regular text-[3.111vw] tracking-wider'>$54.99</p>
                    </div>
                    <div className='flex justify-between mt-0.5'>
                        <h2 className='font-atkinson-bold text-[3.111vw] tracking-wider'>Next-Day</h2>
                        <p className='font-atkinson-regular text-[3.111vw] tracking-wider'>$44.99</p>
                    ...
                    <h1 className="font-atkinson-bold text-[var(--color-pink)] text-[4vw] tracking-wider text-center mt-6 mb-4">B&W RUSH SERVICES:<br /> PLEASE INQUIRE BEFORE DROP-OFF</h1>
