// src/components/DesktopCheckout.jsx
...
const DesktopCheckout = ({ cart, total, orderSummaryOpen, setOrderSummaryOpen, notes, setNotes, contact, billingData, shippingData, payment, discount, submitted, fieldClass }) => {
                ...
                <div>
                    ...
                    <div className="relative w-full mt-8">
                        ...
                        <button
                            ...
                            className="absolute right-2 top-1/2 -translate-y-1/2 text-[0.7vw] text-[#9C9C9C] font-atkinson-bold tracking-widest"
                        >
